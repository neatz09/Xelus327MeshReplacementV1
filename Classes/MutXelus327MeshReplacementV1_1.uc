...
function ApplyHQPickupTexture(Actor Other)
{
    ...
    else if (Other.Class == class'HealthCharger')
    {
        ...
        || Other.Class == class'SuperShieldCharger'
        || Other.Class == class'UDamageCharger')
    {
...
function bool ReplaceCharger(Actor Other, class<xPickupBase> ReplacementClass)
{
    ...
    NewCharger.SetLocation(OldCharger.Location);
    ...
    NewCharger.PrePivot = OldCharger.PrePivot;
    ...
    if (xWeaponBase(OldCharger) != None && NewCharger.MyPickup != None)
    {
        NewCharger.MyPickup.SetDrawType(DT_None);
        NewCharger.MyPickup.SetCollision(false, false, false);
        NewCharger.MyPickup.bHidden = true;
    }
...
function bool CheckReplacement(Actor Other, out byte bSuperRelevant)
{
    ...
    if (Other.IsA('XelusHealthVialPickup'))
        return true;

    if (Other.IsA('XelusHealthCharger')
    ...
    else if (bEnableXelusChargers && Other.Class == class'SuperShieldCharger')
    {
        if (ReplaceCharger(Other, class'XelusSuperShieldCharger'))
            return false;
    }
    else if (bEnableXelusChargers && Other.Class == class'UDamageCharger')
    {
        if (ReplaceCharger(Other, class'XelusUDamageCharger'))
            return false;
    }
    else if (bEnableXelusChargers && Other.IsA('xWeaponBase'))
    {
